...
function randProbPrimeRounds(k, n) {
  let ans; let i; let divisible; let
    B;
...
function randTruePrime_(ans, k) {
  let c; let m; let pm; let dd; let j; let r; let B; let divisible; let z; let zz; let
    recSize;
...
// y is destroyed.
function GCD_(x, y) {
  let i; let xp; let yp; let A; let B; let C; let D; let q; let
    sing;
...
function divide_(x, y, q, r) {
  let kx; let
    ky;
  let i; let j; let y1; let y2; let c; let a; let
    b;
  copy_(r, x);
...
str2bigInt = function str2bigInt(s, base, minSize) {
  let d; let i; let j; let x; let y; let
    kk;
  let k = s.length;
...
function squareMod_(x, n) {
  let i; let j; let d; let c; let kx; let kn; let
    k;
...
function mont_(x, y, n, np) {
  let i; let j; let c; let ui; let t; let
    ks;
  let kn = n.length;
  let ky = y.length;
